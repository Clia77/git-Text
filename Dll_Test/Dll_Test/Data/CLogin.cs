...
namespace Dll_Test {
    public class CLogin {
        private class structureLogInParameter : ICloneable {
            public string[] strLoginParameter = new string[ ( int )CConfig.enumUserAuthorityLevel.USER_AUTHORITY_LEVEL_FINAL ];
        ...
        private void LoadUserInformationParameter()
        {
            do {
                ...
                if( false == File.Exists( strPath ) ) {
                    ...
                    m_objLogInParameter = JsonConvert.DeserializeObject<structureLogInParameter>( json );
        ...
        private void SaveUserInformationParameter()
        {
            ...
            do {
                ...
                structureLogInParameter obj = new structureLogInParameter();
