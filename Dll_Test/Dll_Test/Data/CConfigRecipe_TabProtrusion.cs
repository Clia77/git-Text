...
namespace Data
{
	public partial class CConfig
	{
		...
		public struct structureTabProtrusionInspectionParameter : ICloneable
		{
			...
			// Center Upper Limit
			public CSpecValue dCenterUpperLimit;
			// Cneter Low Limit
			public CSpecValue dCenterLowerLimit;
			// End Upper Limit
			public CSpecValue dEndUpperLimit;
			// End Low Limit
			public CSpecValue dEndLowerLimit;
			public void Init()
			{
				this.dCenterUpperLimit = new CSpecValue();
				this.dCenterLowerLimit = new CSpecValue();
				this.dEndUpperLimit = new CSpecValue();
				this.dEndLowerLimit = new CSpecValue();
			}

			public object Clone()
			{
				structureNtcInspectionParameter obj = new structureNtcInspectionParameter();
				obj.dCellToNtcHeight = ( CSpecValue )this.dCenterUpperLimit.Clone();
				obj.dPadToNtcHeight = ( CSpecValue )this.dCenterLowerLimit.Clone();
				obj.dPadToCellDistance = ( CSpecValue )this.dEndUpperLimit.Clone();
				obj.dNtcPosition = ( CSpecValue )this.dEndLowerLimit.Clone();
				return obj;
			}
		}
