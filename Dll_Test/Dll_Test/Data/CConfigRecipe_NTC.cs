...
namespace Data
{
	public partial class CConfig
	{
		...
		public struct structureNtcInspectionParameter : ICloneable
		{
			...
			/// Cell 에서 NTC 까지 높이
			/// </summary>
			public CSpecValue dCellToNtcHeight;
			/// <summary>
			/// Pad 에서 NTC 까지 높이
			/// </summary>
			public CSpecValue dPadToNtcHeight;
			/// <summary>
			/// Pad 에서 Cell 까지 거리
			/// </summary>
			public CSpecValue dPadToCellDistance;
			/// <summary>
			/// NTC 포지션 스펙값
			/// </summary>
			public CSpecValue dNtcPosition;

			public void Init()
			{
				this.dCellToNtcHeight = new CSpecValue();
				this.dPadToNtcHeight = new CSpecValue();
				this.dPadToCellDistance = new CSpecValue();
				this.dNtcPosition = new CSpecValue();
			}

			public object Clone()
			{
				structureNtcInspectionParameter obj = new structureNtcInspectionParameter();
				obj.dCellToNtcHeight = ( CSpecValue )this.dCellToNtcHeight.Clone();
				obj.dPadToNtcHeight = ( CSpecValue )this.dPadToNtcHeight.Clone();
				obj.dPadToCellDistance = ( CSpecValue )this.dPadToCellDistance.Clone();
				obj.dNtcPosition = ( CSpecValue )this.dNtcPosition.Clone();
				return obj;
			}
		}
