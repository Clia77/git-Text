...
namespace Deepnoid_MemoryMap
{
	...
	/// 바이트형 데이터 클래스 입니다.
	/// </summary>
	public sealed class CMemoryMapData_Byte : IDisposable
	{
		/// <summary>
		/// 메모리 맵 파일 입니다.
		/// </summary>
		...
		public CMemoryMapData_Byte( MemoryMappedFile memMap, long offset, long size, MemoryMappedFileAccess access )
		{
			_memMap = memMap;
		...
		public void Copy( CMemoryMapData_Byte sourceData )
		{
