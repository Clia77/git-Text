...
namespace Deepnoid_MemoryMap
{
	...
	/// 플롯형 데이터 클래스 입니다.
	/// </summary>
	public sealed class CMemoryMapData_Float : IDisposable
	{
		/// <summary>
		/// 메모리 맵 파일 입니다.
		/// </summary>
		...
		public CMemoryMapData_Float( MemoryMappedFile memMap, long offset, long size, MemoryMappedFileAccess access )
		{
			_memMap = memMap;
		...
		public void Copy( CMemoryMapData_Float sourceData )
		{
