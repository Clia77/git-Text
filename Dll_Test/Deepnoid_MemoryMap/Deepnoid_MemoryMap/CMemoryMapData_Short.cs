...
namespace Deepnoid_MemoryMap
{
	...
	/// 쇼트형 데이터 클래스 입니다.
	/// </summary>
	public sealed class CMemoryMapData_Short : IDisposable
	{
		/// <summary>
		/// 메모리 맵 파일 입니다.
		/// </summary>
		...
		public CMemoryMapData_Short( MemoryMappedFile memMap, long offset, long size, MemoryMappedFileAccess access )
		{
			_memMap = memMap;
		...
		public void Copy( CMemoryMapData_Short sourceData )
		{
