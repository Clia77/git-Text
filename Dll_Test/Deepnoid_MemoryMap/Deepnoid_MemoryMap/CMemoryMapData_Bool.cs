...
namespace Deepnoid_MemoryMap
{
	...
	/// 불형 데이터 클래스 입니다.
	/// </summary>
	public sealed class CMemoryMapData_Bool : IDisposable
	{
		/// <summary>
		/// 메모리 맵 파일 입니다.
		/// </summary>
		...
		public CMemoryMapData_Bool( MemoryMappedFile memMap, long offset, long size, MemoryMappedFileAccess access )
		{
			_memMap = memMap;
		...
		public void Copy( CMemoryMapData_Bool sourceData )
		{
