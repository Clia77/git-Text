...
namespace Deepnoid_MemoryMap
{
	...
	/// 더블형 데이터 클래스 입니다.
	/// </summary>
	public sealed class CMemoryMapData_Double : IDisposable
	{
		/// <summary>
		/// 메모리 맵 파일 입니다.
		/// </summary>
		...
		public CMemoryMapData_Double( MemoryMappedFile memMap, long offset, long size, MemoryMappedFileAccess access )
		{
			_memMap = memMap;
		...
		public void Copy( CMemoryMapData_Double sourceData )
		{
