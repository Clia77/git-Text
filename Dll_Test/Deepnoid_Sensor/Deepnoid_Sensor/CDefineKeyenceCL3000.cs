...
namespace Deepnoid_Sensor {
    ...
    public class NativeMethods {
        ...
        [DllImport( DllName )]
        public static extern int CL3IF_OpenEthernetCommunication( int deviceId, ref CL3IF_ETHERNET_SETTING ethernetSetting, uint timeout );
        [DllImport( DllName )]
        ...
        [DllImport( DllName )]
        public static extern int CL3IF_GetTrendIndex( int deviceId, out uint index );
        [DllImport( DllName )]
        public static extern int CL3IF_GetTrendData( int deviceId, uint index, uint requestDataCount, out uint nextIndex, out uint obtainedDataCount, out CL3IF_OUTNO outTarget, IntPtr measurementData );
        [DllImport( DllName )]
        ...
        [DllImport( DllName )]
        public static extern int CL3IF_GetTerminalStatus( int deviceId, out ushort inputTerminalStatus, out ushort outputTerminalStatus );
        [DllImport( DllName )]
        internal static extern int CL3IF_GetPulseCount( int deviceId, out int pulseCount );
        [DllImport( DllName )]
        public static extern int CL3IF_ResetPulseCount( int deviceId );
        [DllImport( DllName )]
        ...
        [DllImport( DllName )]
        public static extern int CL3IF_SetEncoder( int deviceId, ref CL3IF_ENCODER_SETTING encoder );
        [DllImport( DllName )]
        ...
        [DllImport( DllName )]
        public static extern int CL3IF_GetEncoder( int deviceId, out CL3IF_ENCODER_SETTING encoder );
        [DllImport( DllName )]
