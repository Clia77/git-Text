...
namespace Deepnoid_Sensor {
    public class CDeviceSensorKeyenceLJX8000A : CDeviceSensorAbstract {
        ...
        public CDeviceSensorKeyenceLJX8000A()
        {
            m_bThreadExit = false;
        ...
        public override bool ScanStart()
        {
            ...
            try {
                ...
                m_objCallbackExceptionMessage( $"Sensor {m_iSensorIndex} ScanStart - {ex.Message}" );
            }
            finally {
        ...
        public override bool ScanStop()
        {
            ...
            try {
                ...
                m_objCallbackExceptionMessage( $"Sensor {m_iSensorIndex} ScanStop - {ex.Message}" );
            }
            finally {
        ...
        public override bool SensorReset( bool bWait )
        {
            ...
            try {
                ...
                m_objCallbackExceptionMessage( $"Sensor {m_iSensorIndex} SensorReset - {ex.Message}" );
            } finally {
        ...
        public bool InitializeHighSpeedDataCommunication( int iReceiveDataSize )
        {
            ...
            try {
                ...
                m_objCallbackExceptionMessage( $"Sensor {m_iSensorIndex} InitializeHighSpeedDataCommunication - {ex.Message}" );
            }
            finally {
        ...
        public bool PreStartHighSpeedDataCommunication( int iSendPosition )
        {
            ...
            try {
                ...
                m_objCallbackExceptionMessage( $"Sensor {m_iSensorIndex} PreStartHighSpeedDataCommunication - {ex.Message}" );
            }
            finally {
        ...
        public bool StartHighSpeedDataCommunication()
        {
            ...
            try {
                ...
                m_objCallbackExceptionMessage( $"Sensor {m_iSensorIndex} StartHighSpeedDataCommunication - {ex.Message}" );
            }
            finally {
        ...
        public bool FinalizeHighSpeedDataCommunication()
        {
            ...
            try {
                ...
                m_objCallbackExceptionMessage( $"Sensor {m_iSensorIndex} FinalizeHighSpeedDataCommunication - {ex.Message}" );
            }
            finally {
        ...
        public bool StartMeasure()
        {
            ...
            try {
                ...
                m_objCallbackExceptionMessage( $"Sensor {m_iSensorIndex} StartMeasure - {ex.Message}" );
            }
            finally {
                m_bHighSpeedConnect = false;
            }
        ...
        public bool StopHighSpeedDataCommunication()
        {
            ...
            try {
                ...
                m_objCallbackExceptionMessage( $"Sensor {m_iSensorIndex} StopHighSpeedDataCommunication - {ex.Message}" );
            }
            finally {
        ...
        public bool StopMeasure()
        {
            ...
            try {
                ...
                m_objCallbackExceptionMessage( $"Sensor {m_iSensorIndex} StopMeasure - {ex.Message}" );
            }
            finally {
                m_bHighSpeedConnect = false;
            }
            ...
            try {
                do {
                    ...
                    if( true == m_bHighSpeedConnect ) {
                        m_objCallbackMessage( $"Sensor {m_iSensorIndex} - Failed to change the exposure time due to interference from high-speed data communication." );
                        break;
                    }
                ...
                m_objCallbackExceptionMessage( $"Sensor {m_iSensorIndex} SetExposureTime - {ex.Message}" );
            }
            finally {
       ...
       /// <returns></returns>
        public bool GetProfileData( uint iBatchPoint )
        {
            ...
            try {
                ...
                m_objCallbackExceptionMessage( $"Sensor {m_iSensorIndex} GetProfileData - {ex.Message}" );
            }
            finally {
        ...
        private void ConvertProfileDataToImageData( List<ProfileData> objProfileData, CScanData objImageData )
        {
            ...
            foreach ( var item in objProfileData ) {
                ...
                objImageData.objSensorDataKeyenceLJX8000A.objListProfileData.Add( iProfileData );
                objImageData.objSensorDataKeyenceLJX8000A.objListLuminanceData.Add( iLuminanceData );
            }
            // double 형으로 변환하자.
            for ( int iLoopCount = 0; iLoopCount < objProfileData.Count; iLoopCount++ ) {
                ...
                objImageData.objSensorDataKeyenceLJX8000A.objListProfileDoubleData.Add( dProfileData );
            }
        }
        /// <summary>
        /// 프로파일 데이터 정보 
        ...
        public bool GetProfileInfo( ref LJX8IF_PROFILE_INFO objProfileInfo )
        {
            ...
            try {
                ...
                m_objCallbackExceptionMessage( $"Sensor {m_iSensorIndex} GetProfileInfo - {ex.Message}" );
            }
            finally {
            ...
            try {
                do {
                    ...
                    if ( iReturn != ( int )Rc.Ok ) {
                        m_objCallbackMessage( string.Format( $"Sensor {m_iSensorIndex} - Connect is Fail" ) );
                        break;
                    }
                    bReturn = true;
                } while ( false );
            } catch ( Exception ex ) {
                m_objCallbackExceptionMessage( $"Sensor {m_iSensorIndex} ConnectSensor - {ex.Message}" );
                bReturn = true;
            } finally {
        ...
        private void DisconnectSensor()
        {
            try {
                do {
                    ...
                    if ( iReturn != ( int )Rc.Ok ) {
                        m_objCallbackMessage( string.Format( $"Sensor {m_iSensorIndex} - Disconnect is Fail" ) );
                        break;
                    }
                    m_bConnect = false;
                } while ( false );
                ...
                m_objCallbackExceptionMessage( $"Sensor {m_iSensorIndex} DisconnectSensor - {ex.Message}" );
            }
            finally {
        ...
        {
            CDeviceSensorKeyenceLJX8000A pThis = ( CDeviceSensorKeyenceLJX8000A )state;
            int iSensorCheck = 0;
