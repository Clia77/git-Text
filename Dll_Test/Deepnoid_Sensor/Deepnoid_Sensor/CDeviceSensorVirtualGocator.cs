        ...
        private bool InitializeImage()
        {
            ...
            do {
                ...
                try {
                    ...
                    List<bool> objListLoadTif = new List<bool>();
        ...
        public override bool ScanStart()
        {
            ...
            do {
                if ( null != m_objCallbackScanData ) {
                    ...
                    m_objCallbackScanData( ( CScanData )objScanData.Clone() );
                }
                m_iImageIndex++;
